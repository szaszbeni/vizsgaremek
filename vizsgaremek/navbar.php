                ...
                <div class='col-lg-12 col-12 d-flex align-items-center'>
                    ...
                    <div>
                        <a href='#' class='custom-btn custom-border-btn btn' data-bs-toggle='modal' data-bs-target='#subscribeModal'>Notify me
                            <i class='bi-arrow-right ms-2'>asd</i>
                        </a>
                    </div>
                    <a class='bi-list offcanvas-icon' data-bs-toggle='offcanvas' href='#offcanvasMenu' role='button' aria-controls='offcanvasMenu'>xd</a>
