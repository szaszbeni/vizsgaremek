...
<div class="blokk">
    <h4 class="belsoCim"><strong>       
        <?php echo $row["uzenoCim"] ?></strong></h4>
    ...
    <?php if (!empty($row["uzenoKep"])): ?>
        <img src="vizsgaremek/kepek/<?php echo str_replace('C:/xampp/htdocs/vizsgaremek/', '', $row["uzenoKep"]); ?>" class="uzenofalKep">
    <?php endif; ?>
</div>
<?php endwhile; ?>