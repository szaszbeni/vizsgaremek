...
<body>
    <!-- Header -->
    <header class="site-header" id="fejlec">
        <div class="container">
                ...
                <div class="col-lg-12 col-12 d-flex">
                    ...
                    <div>
                        <a href="#" class="custom-btn custom-border-btn btn" data-bs-toggle="modal" data-bs-target="#subscribeModal">
                            Notify me<i class="bi-arrow-right ms-2"></i>
                        </a>
                    </div>
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
        ...
        <div class="offcanvas-body d-flex flex-column justify-content-center align-items-center">
            <nav>
                <ul>
                    <li><a href="login_form.php">Login Form</a></li>
                    <li><a class="active" href="reg_form.php">Create an account</a></li>
                    <li><a href="jelszo_form.php">Password Reset</a></li>
                    <li><a href="404_kulso.php">404 Page</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-lg-6 col-md-6 col-7">
                                    <p class="mb-0">Already have an account? <a href="login_form.php" class="ms-2">Login</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
