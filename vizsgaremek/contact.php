                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            <form class="custom-form contact-form" target="kisablak" action="actions/uzenofalFeldolgozas.php" role="form" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-floating">
                                        <input type="file" class="form-file" name="kep">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-10 mx-auto">
                                        <button type="submit" name="kozzetetel" class="form-control">Send Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
