    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">                
        ...
        <div class="offcanvas-body d-flex flex-column justify-content-center align-items-center">
            <nav>
                <ul>
                    <li>
                        <a class="active" href="login_form.php">Login Form</a>
                    </li>
                    <li>
                        <a href="reg_form.php">Create an account</a>
                    </li>
                    <li>
                        <a href="jelszo_form.php">Password Reset</a>
                    </li>
                    <li>
                        <a href="404_belso.php">404 Page</a>
                    </li>
                    <li>
                ...
                <div class="col-lg-5 col-12 mx-auto">
                    <form action="login_ir.php" method="post" target="kisablak">
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-lg-5 col-12">
                                <a href="reg_form.php" class="btn custom-btn custom-border-btn">Register</a>
                            </div>
                        </div>
                    </form>
                </div>
